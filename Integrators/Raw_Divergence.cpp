...
#include <cmath>
#include <array>
#include "C:\Users\dell\Desktop\Code Folder\Computational physics\Lorenz-System---Computational-Study-of-Lyapunov-Exponent-\System\Lorenz_System.hpp"
...
int main()
{
    ...
    std::ofstream file("lorenz_RD.csv");
    file << "i,x,y,z\n";
    std::ofstream file2("lorenz2_RD.csv");
    file2 << "i,x,y,z\n";
    std::ofstream divfile("lorenz_divergence_RD.csv");
